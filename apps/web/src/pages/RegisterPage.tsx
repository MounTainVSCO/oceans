          ...
          <div className="w-full max-w-md">
            <div className="text-center mb-12">
              <div className="space-y-2">
                <h6 className="text-2xl font-bold tracking-wide text-amber-800" style={{ fontFamily: "'Amatic SC', cursive" }}>Join us,</h6>
              ...
              <p className="mt-6 text-xl leading-8 text-amber-800" style={{ fontFamily: "'Amatic SC', cursive" }}>
                Begin documenting your life's beautiful moments and milestones.
              </p>
            </div>
